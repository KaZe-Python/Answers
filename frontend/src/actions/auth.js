...
export const signup = (email, username, password, re_password, name) => async dispatch => {
    ...
    const body = JSON.stringify({email, username, password, re_password, name});
    try{
...
export const reset_password = (email) => async dispatch =>{
    ...
    try{
        await axios.post(`${REACT_APP_API_URL}/api/v1/auth/users/reset_password/`, body, config);
...
export const reset_password_confirm = (uid, token, new_password, re_new_password) => async dispatch => {
    ...
    try{
        ...
        await axios.post(`${REACT_APP_API_URL}/api/v1/auth/users/reset_password_confirm`, body, config)
